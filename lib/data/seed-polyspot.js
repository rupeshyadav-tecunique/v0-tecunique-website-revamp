...
const polyspotData = {
  ...
  sections: [
    ...
    {
      title: 'Supporting Multiple Product Releases',
      subtitle: 'From Initial Redevelopment to Ongoing Product Evolution',
      content: 'Across more than three years, the team supported several major and minor PolySpot releases.\n\nThe engagement evolved from the original GWT UI redevelopment into administration functionality, custom UI/framework development, product installer responsibilities, selected backend-engine features, expanded QA and automation, release/version management, technical documentation, and post-release product support.\n\nThe team continued adapting as the product architecture and frontend technologies evolved across successive versions.'
    },
    {
      title: 'When PolySpot Reached the End of Its Product Lifecycle',
      subtitle: 'The End of PolySpot — Not the End of the Relationship',
      content: 'By June 2013, PolySpot reached the end of its product lifecycle after the business did not achieve the sales required to continue the product. The TECUNIQUE engagement therefore concluded.\n\nHowever, the established team and relationships created through PolySpot continued. Most members of the dedicated TECUNIQUE team subsequently moved into the new CustomerMatrix engagement, preserving much of the working knowledge, engineering experience and team continuity developed through PolySpot.'
    }
  ],
  gwtChallenge: {
    title: 'Building Expertise Around an Emerging GWT Stack',
  ...
  techStackNote: 'The technology environment evolved throughout the three-year engagement. GWT provided the original frontend foundation, with JavaScript, jQuery and later Angular incorporated as the product interface and architecture changed.',
  ...
  timeline: [
    ...
    {
      year: 'June 2013',
      title: 'PolySpot Concludes → CustomerMatrix Begins',
      desc: 'Most established team members subsequently continue directly into CustomerMatrix.'
    }
  ],
  testimonial: {
