...
const appfireData = {
  ...
  richFiltersExpansion: {
    ...
    desc: 'The relationship expanded again in 2023 when Appfire acquired Qotilabs. The existing TECUNIQUE QA team supporting Rich Filters continued under Appfire, extending the collaboration across another established Atlassian Marketplace product line.',
  ...
  timeline: [
    ...
    },
    {
      ...
      desc: 'The engagement concluded in 2025 as Appfire evolved its internal engineering model.'
    }
  ],
  testimonial: {
