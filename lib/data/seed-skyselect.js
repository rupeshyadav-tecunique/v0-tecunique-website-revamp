...
const skyselectData = {
  ...
  sections: [
    ...
    {
      title: 'A Planned Transition, Not an Exit Problem',
      subtitle: 'Success Meant the Team Could Move to SkySelect',
      content: 'The transition was not an unexpected end to the engagement. It was part of the longer-term intention behind the operating model.\n\nTECUNIQUE’s role was to help SkySelect enter India quickly, build and stabilize the organization, and support the company until it was ready to operate the team through its own Indian entity.\n\nAfter approximately two years, once SkySelect India was established and the operation was fully functional, the team members were transferred to the new entity.'
    },
    {
      title: 'What This Engagement Demonstrates',
      subtitle: 'Building an India Team Without Waiting for the India Entity',
      content: 'The SkySelect engagement demonstrates a different form of dedicated-team partnership. TECUNIQUE did not own the client’s software delivery; instead, it provided the recruitment, employment, and operational foundation that allowed SkySelect to build its own team quickly and manage that team directly.\n\nThe model enabled SkySelect to begin with a small India presence, scale to more than 60 professionals, establish a functioning local organization, and subsequently transition that organization into its own Indian entity.'
    }
  ],
  engagementBlocks: [
    {
  ...
  responsibilityCallout: {
    ...
    content: 'SkySelect retained responsibility for technical priorities, day-to-day team management, individual performance, and software or operational deliverables. TECUNIQUE’s responsibility was to build and support the local team and employment infrastructure.'
  },
  teamGrowthMetric: {
    start: '~7',
    end: '60+',
    label: 'Team Growth in ~1 Year',
    description: 'Expanded from approximately 7 people to more than 60 professionals across software engineering, quality assurance, and business operations.'
  },
  teamCategories: [
    {
      type: 'Technical Team',
    ...
    },
    {
      ...
      desc: 'An India-based operations team supporting procurement, sourcing, and order fulfillment activities for airline and MRO customers.',
  ...
  cta: {
    ...
    title: 'Start Your India Engineering Team Without Waiting for Everything to Be in Place',
...
async function main() {
  ...
  console.log('MongoDB update successful for SkySelect:', result);
  await client.close();
}
