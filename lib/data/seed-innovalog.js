...
const innovalogData = {
  ...
  heroSubtitle: 'How Innovalog expanded the engineering and QA capacity behind JMWE through a long-term collaboration with TECUNIQUE across JMWE Cloud development, Cloud and Data Center QA, automation, and Tier-3 technical support.',
  seoTitle: 'JMWE Development & QA Case Study',
  metaDescription: 'See how TECUNIQUE supported Innovalog with JMWE Cloud development, Cloud and Data Center QA, automation, and Tier-3 technical support through a long-term engineering partnership.',
  ...
  description: 'As demand for JMWE grew, Innovalog needed to expand its development capacity while continuing to support an increasingly established app in the Atlassian Marketplace.',
  ...
  engagementBlocks: [
    ...
    },
    {
      ...
      description: 'TECUNIQUE provided QA support across both JMWE Cloud and JMWE Data Center, covering functional testing, regression testing, release validation, and ongoing product QA.',
  ...
  techStack: [
    {
      category: 'JMWE Cloud Development',
      items: ['TypeScript', 'React.js', 'Node.js']
    },
    {
      category: 'Atlassian Platform & Ecosystem',
  ...
  milestones: [
    ...
    },
    {
      ...
      description: 'The long-term team retained deeper knowledge of JMWE as the product evolved.'
    }
  ],
  results: [
    {
