...
export function ServicesHero() {
  ...
  return (
    <section className="brand-hero-bg relative overflow-hidden pt-12 pb-16 lg:pt-16 lg:pb-20 bg-white">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 text-center">
        <SectionReveal className="mx-auto max-w-4xl flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            <Button
              size="lg"
              className="rounded-full px-8 h-12 text-base font-bold shadow-lg hover:shadow-xl transition-all bg-brand-blue hover:bg-brand-blue-hover w-full sm:w-auto group"
              asChild
            >
              <Link href="/contact">
            ...
            <Button
              ...
              className="rounded-full px-8 h-12 text-base font-bold border-2 border-slate-200 hover:bg-slate-50 transition-all w-full sm:w-auto text-slate-700 cursor-pointer"
            >
              Explore Services
            </Button>
          </div>
