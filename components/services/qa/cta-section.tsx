        ...
        <div className="mx-auto max-w-3xl text-center">
          <SectionReveal>
            ...
            <h2 className="font-display text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl leading-tight">
              Need a Dedicated QA or <br className="hidden sm:block" />
              <span className="gradient-text">Automation Team?</span>
            </h2>

            <p className="mt-6 text-xl text-slate-600 leading-relaxed max-w-xl mx-auto">
              Tell us about your product, release process, testing gaps, and automation goals. TECUNIQUE can help you build a dedicated QA team.
            </p>
