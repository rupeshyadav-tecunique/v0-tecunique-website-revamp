    ...
    <section className="py-24 bg-[var(--neutral-slate-50)] relative border-b border-[var(--neutral-slate-200)]/50">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <SectionReveal className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">TECUNIQUE is a good fit for product companies that need QA engineers who can stay with the product long enough to understand its behaviour, users, domain, and release patterns.</p>
        </SectionReveal>
