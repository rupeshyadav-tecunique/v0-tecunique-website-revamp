      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <SectionReveal direction="left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--surface-blue)] border border-[var(--surface-blue-strong)] text-brand-blue text-sm font-semibold mb-8 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Link
                href="/contact"
                className="inline-flex h-12 items-center justify-center rounded-full bg-brand-blue px-8 text-base font-bold text-white shadow-lg transition-all hover:bg-brand-blue-hover hover:scale-105 w-full sm:w-auto"
              >
                Build Your Team
