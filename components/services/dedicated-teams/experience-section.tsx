...
export function DedicatedTeamsExperience() {
  return (
    <>
      ...
      <section className="py-24 lg:py-32 bg-white border-t border-[var(--neutral-slate-200)]/50 relative overflow-hidden">
        <div className="mx-auto max-w-4xl px-6 lg:px-8 relative z-10">
          <SectionReveal className="text-center">
            <div className="flex flex-col items-center mb-8">
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--surface-blue)] border border-[var(--surface-blue-strong)] text-brand-blue text-sm font-semibold mb-6">
                Client Relationship Highlight
              </span>
            </div>
            <p className="text-2xl font-medium leading-relaxed text-foreground mb-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="font-bold text-foreground">Innovalog</div>
            </div>
          </SectionReveal>
        </div>
      </section>
